  ...
  void initState() {
    ...
    try {
      ...
      quickActions.setShortcutItems(<ShortcutItem>[
        const ShortcutItem(type: 'action_hcm', localizedTitle: '检查打卡情况'),
        const ShortcutItem(type: 'action_clean', localizedTitle: '完成清洁'),
        const ShortcutItem(type: 'action_quicklink', localizedTitle: '查找短链'),
        // const ShortcutItem(
        //     type: 'action_add_quicklink_short', localizedTitle: '添加短链接'),
        // const ShortcutItem(
        //     type: 'action_add_quicklink_long', localizedTitle: '从剪贴板添加短链接'),
        const ShortcutItem(type: 'action_add_good', localizedTitle: '物品入库')
      ]);
    } on Exception {
