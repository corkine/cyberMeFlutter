                ...
                Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          Row(
                              ...
                              children: [
                                Transform.translate(
                                    ...
                                    child: Text(
                                        car.status.range.toStringAsFixed(0),
                          ...
                          buildRow(
                              "状态",
                              car.status.parkingBrake == "active"
                                  ? "已驻车"
                                  : "未驻车",
                              "机油",
                          ...
                          buildRow(
                              "气温",
                              car.status.outTemp.toStringAsFixed(1) + "°C",
                              "车速",
                              car.status.speed.toStringAsFixed(0) + " km/h"),
                          const SizedBox(height: 10),
                          buildRow(
                              "车门",
                              car.status.doors == "closed" ? "已关闭" : "开启",
                              "车窗",
                            ...
                            Positioned(
                                ...
                                child: Transform.rotate(
                                    ...
                                    child: const Icon(Icons.place,
                                        color: Color.fromARGB(75, 255, 45, 25),
                                        size: 50)))
                          ]),
                          const SizedBox(height: 10),
                          buildRow(
                              "生涯油耗",
                              car.trip.fuel.toStringAsFixed(0) + "L",
                              "生涯里程",
                              car.trip.mileage.toStringAsFixed(0) + " km"),
                          const SizedBox(height: 10),
                          buildRow(
                              "平均油耗",
                              car.trip.averageFuel.toStringAsFixed(1) +
                                  "L/100km",
                              "",
                              ""),
